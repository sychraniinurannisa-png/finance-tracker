      ...
      <div className="bg-white border border-slate-200/60 rounded-2xl p-5 shadow-sm space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="p-4 bg-slate-50/30 border border-slate-200/60 rounded-xl space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-slate-800">Makanan & Minuman</span>
              </div>
          ...
          <div className="p-4 bg-slate-50/30 border border-slate-200/60 rounded-xl space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="p-2 bg-blue-100 text-blue-600 rounded-lg text-xs">
                  <i className="fa-solid fa-car"></i>
                </span>
                <span className="text-xs font-bold text-slate-800">Transportasi</span>
              </div>
              <span className="text-[11px] font-bold text-slate-500">21%</span>
            </div>
            <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
              <div className="bg-blue-400 h-full rounded-full" style={{ width: '21%' }}></div>
            </div>
            <div className="flex items-center justify-between text-[10px] text-slate-400">
              <span>Terpakai: Rp 320.000</span>
          ...
          <div className="p-4 bg-slate-50/30 border border-slate-200/60 rounded-xl space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="p-2 bg-rose-100 text-rose-600 rounded-lg text-xs">
                  <i className="fa-solid fa-receipt"></i>
                </span>
                <span className="text-xs font-bold text-slate-800">Tagihan & Utilitas</span>
              </div>
              <span className="text-[11px] font-bold text-rose-600">90%</span>
            </div>
            <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
              <div className="bg-rose-500 h-full rounded-full" style={{ width: '90%' }}></div>
            </div>
            <div className="flex items-center justify-between text-[10px] text-slate-400">
              <span>Terpakai: Rp 1.800.000</span>
          ...
          <div className="p-4 bg-slate-50/30 border border-slate-200/60 rounded-xl space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="p-2 bg-purple-100 text-purple-600 rounded-lg text-xs">
                  <i className="fa-solid fa-gamepad"></i>
                </span>
                <span className="text-xs font-bold text-slate-800">Hiburan & Plesir</span>
              </div>
              <span className="text-[11px] font-bold text-slate-500">12%</span>
            </div>
            <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
              <div className="bg-purple-400 h-full rounded-full" style={{ width: '12%' }}></div>
            </div>
            <div className="flex items-center justify-between text-[10px] text-slate-400">
              <span>Terpakai: Rp 120.000</span>
              <span>Batas: Rp 1.000.000</span>
            </div>
          </div>
        </div>
      </div>
